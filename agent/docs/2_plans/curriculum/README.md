...
Reward: a **holdings potential** over the objects held and packed, and **reveal novelty** — the first reveal of each held object. Holdings is listed in the reward (`../../3_decisions/reward.md`) as "no — object detection," but the specifier decoding now exists; the potential is available.
